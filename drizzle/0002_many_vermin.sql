...
INSERT INTO `__new_game`("id", "category", "timeControl", "whiteId", "blackId", "outcome", "winner", "messages", "whiteTimer", "blackTimer", "createdAt") SELECT "id", "category", "timeControl", "whiteId", "blackId", "outcome", "winner", "messages", "whiteTimer", "blackTimer", "createdAt" FROM `game`;--> statement-breakpoint
