...
export const BoardHistory = () => {
  ...
  return (
    <div className="h-full w-full xl:max-w-lg">
      <Tabs
      ...
      >
        ...
        <TabsContent
          value={"history"}
          className="gap-2 grid grid-rows-[minmax(0,1fr)_auto]"
        >
          <Card className="grid grid-rows-[auto_minmax(0,1fr)]">
            <CardHeader>
              <CardTitle>History</CardTitle>
              <CardDescription>
                List of the moves played during this game
              </CardDescription>
            </CardHeader>
